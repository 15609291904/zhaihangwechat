...
Page({
  ...
  tozhaiwu(){
    wx.navigateTo({
      url: '/pages/myclaimswu/myclaimswu',
    })
  },
  // 查看协议
  lookagreement(e){
    ...
    wx.request({
      ...
      success(res) {
        ...
        wx.navigateTo({
          url: '/pages/viewagreement/viewagreement?claim_id=' + e.currentTarget.dataset.id + "&broker_uid=" + that.data.broker_id + "&entrust_uid=" + e.currentTarget.dataset.entrust_uid,
        })
      }
    })    
  },
